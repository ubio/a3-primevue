...
export const ErrorMessage: DefineComponent<Record<string, unknown>, Record<string, unknown>, any>;
export const Filler: DefineComponent<Record<string, unknown>, Record<string, unknown>, any>;
...
export const TreeItem: DefineComponent<Record<string, unknown>, Record<string, unknown>, any>;
export const TreeView: DefineComponent<Record<string, unknown>, Record<string, unknown>, any>;
export const VGroup: DefineComponent<Record<string, unknown>, Record<string, unknown>, any>;

export function setupVue(vue: VueApp): void;
